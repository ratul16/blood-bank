        ...
        <div class="row" id="profile">
            <div class="col-md-10">
                <div class="card bg-light" style="margin-top:20px; width:1100px;">
                    <div class="card-body" style="margin-left:20px;"><img class="rounded-circle" src="img/avater.png"
                        ...
                        <h4 class="card-title" style="padding-top:20px;">Hasibul Alam Ratul<h4>
                                ...
                                <button type="button" class="btn btn-info"><a
                                        href="doctor.php" style="color:#ffffff;">Can donate</a></button>
                                <button type="button" class="btn btn-warning"><a
                                        href="doctor.php" style="color:#ffffff;">Can't donate</a></button>
                    </div>
                </div>
                <br>
            ...
            <div class="col-md-2">
                <button id="logout" type="button" class="btn btn-danger"><a href="doctor.php"
                        style="color:#ffffff;">Logout</a></button>
            </div>
            <div class="col-md-2">
                <small class="text-danger">Remove profile ? </small><br>
                <button type="button" id="logout" class="btn btn-danger"><a href="doctor.php"
                        style="color:#ffffff;">Delete</a></button>
            </div>
        </div>
